...
### I organize Wausau.js

<img src="./wausaujs.png" style={{ width: '400px', marginLeft: '1rem' }} />

[RSVP on Meetup](https://www.meetup.com/Wausaujs/)
...
```notes
Get logos of languages that have implmentations
```
...
<iframe
  ...
  style={{ width: 800, height: 600, transform: 'scale(1.2)' }}
  frameBorder="0"
/>
